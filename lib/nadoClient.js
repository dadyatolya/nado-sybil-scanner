 ...
 * by the /api/debug/probe route in server.js to see exactly what's wrong
 * once this is running somewhere with real network access — wrong request
 * shape, wrong base URL, auth required, unexpected response format, etc.
 * Safe to leave deployed: read-only, no side effects, no secrets touched. */
